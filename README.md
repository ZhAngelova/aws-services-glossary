...
A collaborative glossary of AWS services, built for the AWS re/Start with AI bootcamp class. Each day we recall and add services and their short description.
